...
class RowSeeder extends Seeder
{
    public function run()
    {
        ...
        $showRows = [
            ...
            1 => [
                ['name' => 'VIP', 'order' => 1, 'total_seats' => 18],
                ['name' => 'A', 'order' => 2, 'total_seats' => 18],
                ['name' => 'B', 'order' => 3, 'total_seats' => 18],
                ['name' => 'C', 'order' => 4, 'total_seats' => 18],
                ['name' => 'D', 'order' => 5, 'total_seats' => 18],
                ['name' => 'E', 'order' => 6, 'total_seats' => 18],
                ['name' => 'F', 'order' => 7, 'total_seats' => 18],
            ],
            ...
            6 => [
                ...
                ['name' => 'C', 'order' => 3, 'total_seats' => 18],
                ['name' => 'D', 'order' => 4, 'total_seats' => 18],
                ['name' => 'E', 'order' => 5, 'total_seats' => 18],
